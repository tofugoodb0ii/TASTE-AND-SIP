...
while True :
    ...
    print('{0:>32}\n{1:>34}\n{2:>32}\n{3:>36}\n{4:>39}\n{5:>37}\n{6:>32}'.format('[1] Nike','[2] Adidas','[3] Vans','[4] Converse','[5] New Balance','[S] Show cart','[X] Exit'))
    ...
    if option == '1':
        while True :
            ...
            choice = input('Select Nike shoe : ').upper() #.upper() = change all input to uppercase
            if choice == '1':
                ...
                print('Error, please try again')  #if input another option

    elif option == '2':
        while True :
            print('\n{0:-<74}\n{1:^74}\n{2:-<74}'.format('','-+ Adidas +-',''))
            print('[1] Stan Smith Shoes - 2300 baht \n[2] Stan Smith CS - 2600 baht \n[3] Stan Smith 80s - 5500 baht \n[X] Return to main menu') 
            choice = input('Select Adidas shoe : ').upper() #.upper() = change all input to uppercase
            if choice == '1':
        ...
        while True :
            ...
            choice = input('Select Vans shoe : ').upper() #.upper() = change all input to uppercase
            if choice == '1':
        ...
        while True :
            ...
            choice = input('Select Converse shoe : ').upper() #.upper() = change all input to uppercase
            if choice == '1':
        ...
        while True :
            ...
            choice = input('Select New Balance shoe : ').upper() #.upper() = change all input to uppercase
            if choice == '1':
        ...
        for i in cart :
            ...
            print('{0:<5}{1:<35}{2:<10.2f}{3:<10.2f}{4:<10.2f}'.format(no, model, price, discount, discount_price)) #Use .2f to changet integer to float
            no += 1 #loop of No. order
        print('{0:=<74}'.format(''))
        print('{0:<5}{1:<35}{2:<10.2f}{3:<10.2f}{4:<10.2f}'.format('', 'Total', total_price, total_discount, total_discount_price))
        print('{0:=<74}\n{1:^74}\n{2:=<74}'.format('','-+ THANK YOU +-',''))
        
    elif option == 'X':
        print('{0:-<70}\n{1:^70}\n{2:-<70}'.format('','-+ Thanks For Your Order +-',''))
        break
