...
if __name__ == "__main__":
    ensure_dirs()
    # เริ่มจาก CTk Login (ดีไซน์ใหม่)
    CTkLogin(db_path=DB_FILE, left_bg_path=LEFT_BG_PATH, logo_path=LOGO_PATH).mainloop()